...
# ── 6. Create wrapper script for logging ─────────────
# PowerShell wrapper lets us capture stdout/stderr to a log file
$wrapperPath = "$INSTALL_DIR\collector-service.ps1"
@"
Set-Location '$INSTALL_DIR'
& '$BINARY' --config '$LOCAL_CONFIG' *>> '$LOG_FILE'
"@ | Set-Content $wrapperPath -Encoding UTF8

# Register service using PowerShell as the host (enables logging)
$psExe = (Get-Command powershell.exe).Source
$binPath = "`"$psExe`" -NonInteractive -ExecutionPolicy Bypass -File `"$wrapperPath`""
